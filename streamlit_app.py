...
bill_length = st.sidebar.slider('Длина клюва (мм)', float(df['bill_length_mm'].min(), float(df['bill_length_mm'].max()),
                                                          float(df['bill_length_mm'].mean())))
bill_depth = st.sidebar.slider('Глубина клюва (мм)', float(df['bill_depth_mm'].min(), float(df['bill_depth_mm'].max()),
...
body_mass = st.sidebar.slider('Масса тела (г)', float(df['body_mass_g'].min(), float(df['body_mass_g'].max()),
